            ...
            <div class="card-body">
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        <?php 
                        $i = 1;
                        $qry = $conn->query("SELECT b.*, f.name as facility, c.name as category, b.quantity FROM `booking_list` b inner join facility_list f on b.facility_id = f.id inner join category_list c on f.category_id = c.id where b.client_id = '{$_settings->userdata('id')}' order by unix_timestamp(b.date_created) desc");
