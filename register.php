      ...
      <div class="card-body">
        <form id="register-frm" action="" method="post">
          ...
          <div class="row">
            ...
            <div class="form-group col-md-6">
                <input type="text" name="contact" id="contact" placeholder="018-1234567" class="form-control form-control-sm form-control-border" required>
          ...
          <div class="row">
            <div class="form-group col-md-12">
              ...
              <textarea name="address" id="address" rows="3" class="form-control form-control-sm rounded-0" placeholder="Kamsis Khadijah"></textarea>
            </div>
          </div>
          <hr>
          <div class="row">
            <div class="form-group col-md-6">
                <input type="email" name="email" id="email" placeholder="bcs2111-135@beranang,kpm.edu.my" class="form-control form-control-sm form-control-border" required>
